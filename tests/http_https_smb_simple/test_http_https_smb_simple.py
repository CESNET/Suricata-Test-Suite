...
from assets.trex.traffic_profiles.http_https_smb_trex_profile.profile import HttpHttpsSmbProfile
...
def test_http_https_smb (
    ...
    trex_client = HttpHttpsSmbProfile(trex_manager, request, get_target_mac, get_target_vlan)
