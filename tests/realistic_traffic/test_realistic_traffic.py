...
Usage:
    Without topology:
        pytest --trex-generator="trex,0000:65:00.0" --remote-host="clarer,0000:3b:00.0" -s --log-level=info
"""
...
from assets.trex.traffic_profiles.realistic_traffic_trex_profile import RealisticTrafficProfile
...
def test_realistic_traffic (
    ...
    trex_client = RealisticTrafficProfile(trex_manager, request, get_target_mac, get_target_vlan, mode=TrexMode.STF)
