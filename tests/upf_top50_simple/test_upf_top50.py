...
from assets.trex.traffic_profiles.upf_dns_top50_profile import UpfDns50Profile
...
def test_upf_top50_norules (
    ...
    trex_client = UpfDns50Profile(trex_manager, request, get_target_mac, get_target_vlan, mode=TrexMode.STF)
