...
- ASTF mode *(advanced stateful)*
  - all traffic is handled with a fully working TPC/IP stack
...
Each mode has it's own strengths but STF and ASTF are most interesting for our use case, since they allow for
