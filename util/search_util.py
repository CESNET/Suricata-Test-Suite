...
def binary_search(
    ...
    Outputs:
        Multiplier value [FLOAT] -> Highest found multiplier with average drop rate <= target.
        Raises MultiplierNotFoundError if no suitable multiplier is no multiplier meets the target
        drop rate.
    """
